...
const ageData = tabularRows(await FileAttachment("data/derived/browser/demographics-age-2022.json").json());
...
const disabilityData = tabularRows(await FileAttachment("data/derived/browser/disability-2022.json").json());
const carersData = tabularRows(await FileAttachment("data/derived/browser/carers-2022.json").json());
const householdCompositionData = tabularRows(await FileAttachment("data/derived/browser/household-composition-2022.json").json());
const deprivationData = tabularRows(await FileAttachment("data/derived/browser/deprivation-index-2022.json").json());
