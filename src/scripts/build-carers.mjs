...
const outputPath = path.join(dataDir, "carers-2022.csv");
...
const edTotal = outputRows.reduce((sum, row) => sum + row.Carers, 0);
...
console.log(`Validated combined-sex carer counts against CSO table ${TABLE}`);
